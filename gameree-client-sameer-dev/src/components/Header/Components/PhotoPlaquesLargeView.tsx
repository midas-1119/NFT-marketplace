...
const PhotoPlaquesLargeView = ({ data }: any) => {
  return (
          ...
          {data.sections.map((section: any) => (
            <div key={section.id}>
              <h6
                ...
                className="text-xl uppercase font-Roboto-Bold"
              >
        ...
        <div>
          {data.section1.map((section: any) => (
            <div key={section.id}>
              <h6
                id={`${section.name}-heading`}
                className="text-xl uppercase font-Roboto-Bold whitespace-nowrap"
              >
                {section.name ? section.name : ""}
              </h6>
              <span className="block text-sm text-red-500 font-Roboto-Bold">
...
export default PhotoPlaquesLargeView;
