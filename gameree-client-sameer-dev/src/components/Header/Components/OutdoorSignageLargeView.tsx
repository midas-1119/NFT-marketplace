...
const OutdoorSignageLargeView = ({ data, close }: any) => {
  return (
      ...
      {data.featured.map((featured: any, i: any) => (
        <div key={i}>
          ...
          >
              ...
              <>
                ...
                >
                  <a>
                    ...
                    >
                      <div>
                        <span className="hover:text-[#418dc7] cursor-pointer text-primary">
                          {item.name}
                        </span>
                      </div>
                    </li>
            ...
            {/* <Link href={{ pathname: router_paths.allProducts, query: { id: data.id, category: featured.name } }}>
              <a>
...
export default OutdoorSignageLargeView;
