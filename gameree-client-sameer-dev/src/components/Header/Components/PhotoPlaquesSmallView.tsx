...
const PhotoPlaquesSmallView = ({ data, close }: any) => {
  return (
    <div>
      ...
      <div className="grid grid-cols-1 mt-12 text-lg  gap-y-10 gap-x-16 text-primary">
        <div>
          {data.sections.map((section: any) => (
            <div key={section.id}>
              ...
              <span className="block mt-3 text-sm text-red-500 font-Roboto-Bold">
                (coming soon)
              </span>
                    ...
                    >
                      <a>
                        <li key={item.name} className="flex">
                          ...
                          ></div>
                          <a className="hover:text-[#418dc7]" title={item.name}>
                            {item.name}
                          </a>
                        </li>
                      </a>
...
export default PhotoPlaquesSmallView;
