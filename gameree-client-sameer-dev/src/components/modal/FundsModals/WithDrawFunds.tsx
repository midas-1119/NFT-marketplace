...
const WithDrawFunds = ({ setstate, setPopup }: any) => {
  ...
  return (
    <div className="sm:w-[44.125rem] w-full">
      <div className="rounded-[3.5rem] bg-black1 py-4 px-8  relative mb-8">
        ...
        ></i>
        <h3 className="text-5xl text-center">WITHDRAW FUNDS</h3>
      </div>
      <h3 className="text-black1 mb-4 text-5xl xs:text-4xl">
        SELECT THE WITHDRAW DETAILS
      </h3>
      ...
      <h4 className="text-xl mb-2 font-Montserrat-Bold text-black mt-8">
        SELECT YOUR TOKEN
      </h4>
      <div className="relative w-[15.375rem] py-4 px-6 border-2 border-[#070E1E] rounded-[16px] flex items-center gap-[0.875rem] cursor-pointer"
      ...
      >
        <Image
          ...
          width={48}
        />
        <h4 className="text-[2rem]  font-TTTrailers-Bold text-[#4F4F4F] ">
          USDT
        </h4>

        <svg
                className="top-[50%] -translate-y-1/2 right-6 absolute"
                width="18"
                height="10"
                viewBox="0 0 12 8"
                fill="none"
      ...
      <div className="mt-12">
        ...
        <div className="relative mb-12">
          ...
          />
          <Button className="top-0 right-0 !absolute rounded-none hover:!bg-black1 bg-black1 rounded-r-2xl text-[2rem] font-TTTrailers-Regular h-full">
            {" "}
