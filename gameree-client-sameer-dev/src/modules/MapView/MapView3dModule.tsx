...
const MapView3d = () => {
    ...
    useEffect(() => {
        map = new mapboxgl.Map({
            ...
            // style: 'mapbox://styles/gameree/clbrqat43000n15qoa6e1wd3u',
        ...
        map.on("load", async (e: any) => {
            ...
            /*************************************** */
            let dLayer = map.getLayer('build_3d')
            console.log("build3d:-=-=-=", dLayer)
            if (dLayer === undefined || !dLayer) {
                map.addLayer(
                    {
                        'id': `build_3d`,
                        'source': `composite`,
            ...
            try {
                ...
                if (response.meta && response.meta.requestStatus === "fulfilled") {
                    ...
                    console.log("Dataarray:-=-=-=", buildings)
